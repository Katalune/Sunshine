...
public class DetailFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    /**
     * Create new instance of the class with arguments bundle.
     * @param uri Uri from the {@code getArguments().getParcelable(DETAIL_URI)}.
     * @return New instance.
     */
     ...
     * Create new instance of the class with arguments bundle.
     * @param uri Uri from the {@code getArguments().getParcelable(DETAIL_URI)}.
     * @param transition_animation Boolean from the
     * {@code getArguments().getBoolean(DETAIL_TRANSITION_ANIMATION)}.
     * @return New instance.
     */
    public static DetailFragment newInstance(Uri uri, boolean transition_animation) {
        DetailFragment f = newInstance(uri);

        Bundle args = f.getArguments();
        args.putBoolean(DETAIL_TRANSITION_ANIMATION, transition_animation);
        f.setArguments(args);
