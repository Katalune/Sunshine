...
public class WeatherMuzeiSource extends MuzeiArtSource {
    ...
    private int INDEX_WEATHER_ID = 0;
    private int INDEX_SHORT_DESC = 1;
    ...
    protected void onUpdate(int reason) {
        ...
        Uri weatherUri = WeatherContract.WeatherEntry.buildWeatherLocationWithStartDate(locationQuery,
                System.currentTimeMillis());
        Cursor cursor = getContentResolver().query(weatherUri, WEATHER_PROJECTION, null, null,
