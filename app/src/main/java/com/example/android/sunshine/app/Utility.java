...
public class Utility {
     ...
     * @param context Context to use for resource localization
     * @param dateInMillis The date in milliseconds
     * @return the name to use for that day. E.g "today", "tomorrow", "wednesday".
     */
     ...
     * @return if the network is available or about to become available.
     */
    ...
    static public @SunshineSyncAdapter.LocationStatus int getLocationStatus(Context c) {
        ...
        int status = prefs.getInt(c.getString(R.string.pref_location_status_key),
