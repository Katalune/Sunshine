...
>>>>>>> udacity/2.00_Integration_Points_and_Error_Cases
 *
...
public class ForecastFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>,
    ...
    public interface Callback {
        /**
         * ForecastFragmentCallback for when an item has been selected.
         */
        void onForecastItemSelected(Uri dateUri, ForecastAdapter.ForecastAdapterViewHolder vh);
    }
        ...
        mForecastAdapter = new ForecastAdapter(getActivity(), new ForecastAdapter.ForecastAdapterOnClickHandler() {
            ...
            public void onClick(Long date, ForecastAdapter.ForecastAdapterViewHolder vh) {
                ...
                ((Callback) getActivity())
                        .onForecastItemSelected(WeatherContract.WeatherEntry.buildWeatherLocationWithDate(
