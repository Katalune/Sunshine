...
public class  SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final String ACTION_DATA_UPDATED = "com.example.and roid.sunshine.app.ACTION_DATA_UPDATED";

    /**
     * Sets the location status into shared preference. This function should not be called from
     * the UI thread because it uses commit to write to the shared prefs.
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            Uri builtUri = uriBuilder.appendQueryParameter(FORMAT_PARAM, format)
                    ...
                    .appendQueryParameter(APPID_PARAM, WEATHER_KEY.KEY)
//                    .appendQueryParameter(APPID_PARAM, BuildConfig.OPEN_WEATHER_MAP_API_KEY)
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        Log.d(LOG_TAG, "Sunshine Service Sync Complete. " + cVVector.size() + " Inserted");

        // delete old data so we don't build up an endless history
        int deleted = getContext().getContentResolver().delete(WeatherContract.WeatherEntry.CONTENT_URI,
                WeatherContract.WeatherEntry.COLUMN_DATE + " <= ?",
                new String[]{Long.toString(dayTime.setJulianDay(julianStartDay - 1))});
        Log.d(LOG_TAG, "Sunshine Service Complete. " + deleted + " deleted");
